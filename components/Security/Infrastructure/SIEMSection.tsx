            ...
            <main>
                ...
                <section className="ssp-section">
                    <div className="container fade-in-section" ref={el => { if(el) sectionsRef.current[7] = el }}>
                        ...
                        <p className="ssp-arch-caption">Log ingestion → normalization → correlation → detection engine → alerts → SOC dashboard → continuous improvement loop.</p>
                    </div>
                </section>
                 ...
                 <section className="ssp-section fade-in-section" ref={el => { if(el) sectionsRef.current[8] = el }}>
                    <div className="container">
                        <h2>Discover More in Infrastructure Security</h2>
                         <div className="ssp-divider"></div>
                        <p>Explore the next Infrastructure Security focus areas: Cloud Workload Protection (CWPP) and Extended Detection & Response (XDR) — enabling complete visibility and faster response across environments.</p>
